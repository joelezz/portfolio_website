...
const Home = () => {
  return (
      ...
      <section id="home">
            <p>Ready to see what modern web development can really do? </p> <br /> <p>I craft user-friendly, dynamic experiences from cutting-edge React frontends to intelligent AI integrations.</p>  <br /> <p>Welcome!</p>    
      <div>
      <a target='_blank'
